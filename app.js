...
// ===== ORIGINAL APP CODE BELOW =====
        ...
        function showLanding() {
            ...
            // Load discovery count for landing page
            loadDiscoveryCount();
        }
        ...
        function createCard(item, index) {
            ...
            // Snippet (prefer note, fallback to description)
 ...
 function initDiscoverMap() {
    ...
    // âœ… Create array with original indices
    ...
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', { attribution: 'Â© OpenStreetMap' }).addTo(discoverMap);
    ...
    located.forEach((d) => {
        ...
        // âœ… Use originalIndex instead of i
        L.marker([lat, lng])
            .addTo(discoverMap)
    ...
    if (bounds.length > 0) discoverMap.fitBounds(bounds, { padding: [30, 30] });
        ...
        function sendMessage(text) {
            ...
            .then(data => {
                ...
                if (data.results && data.results.length > 0) {
                    ...
                    // Build TOP PICK card (first result)
                    ...
                    // TOP PICKS section (first 1-2 results)
                    ...
                    // MORE GREAT OPTIONS section (remaining results in 2-col grid)
                    const moreResults = data.results.slice(topPickCount);
                    const initialShowCount = 4; // Show first 4 in grid initially
        ...
        async function submitDiscovery(e) {
            ...
            const payload = {
                ...
                addedBy: document.getElementById('addedBy').value.trim() || 'Stanley',
                address: document.getElementById('address').value.trim() || null,
                url: document.getElementById('url').value.trim() || null,
                UserID: '4c81734b-63a1-44fb-9c54-ed14760e16e7',
